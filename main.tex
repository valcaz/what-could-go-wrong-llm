...
\begin{multicols}{2}
    \begin{enumerate}\tiny \setlength\itemsep{.1ex}
        \item All players draw 5 event cards from their stack.
        \item Use the spinner to select the Card Czar.
        \item The Card Czar reads a black prompt card to the group. If unsure about the prompt word, players clarify collectively or defer to the Card Czar's decision.
